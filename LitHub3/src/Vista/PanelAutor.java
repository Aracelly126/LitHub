...
public ControlAutores contAutor=new ControlAutores();
    ...
    private void btnregistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregistrarActionPerformed
     boolean aux=contAutor.registroAutores(this.txtnombre.getText(),this.txtapellido.getText(),this.comboPais.getSelectedItem().toString(),this.txtfecha.getText(),Integer.parseInt(this.txtobras.getText()),this.txtcorreo.getText(),this.txtcontra.getText());
        if (aux) {
